<template>
    <div class="input" style="    width: 90% !important;">
        <b-input-group class="input">
            <button class="inputpre" style="width: 50px; height: 50px;">
            ...
            <button @click="getLocation" class="inputpre" style="width: 50px; height: 50px;">
...
export default {
    ...
    methods: {
        ...
        async weatherLocation() {
            const num = this.selectedCity.indexOf(',')
            let city = this.selectedCity.substring(0, num);
            // console.log(city);
