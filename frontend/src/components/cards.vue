  ...
  <div class="results">
    <div :style="[darkMode ? $store.state.dark : { color: 'black' }]" class="card-1">
      ...
      <div class="cards">
        <div class="today">
          ...
          <div class="daily">
            <img :src="require(`../assets/weater_elements/${weathers[daily.weather[0].main]}.svg`)" width="220px" alt />
    ...
    <div :style="[darkMode ? $store.state.dark : { color: 'black' }]" class="card-2">
      ...
      <div class="daysDetail">
        <span style="display:flex; flex-direction:column; align-items:center; padding-left:10px"
